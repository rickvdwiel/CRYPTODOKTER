...
MAX_POSITIONS = 10
POSITION_SIZE_PCT = 1.0  # Titan hyper GO Desk; was 2.0
...
MAX_HOLD_MINUTES = 12  # Titan hyper GO Desk; was 45
ROTATE_SCORE_EDGE = 5.0  # Titan hyper GO Desk; was 8

# Auto-koop
MIN_SCORE = 28.0              # Desk/Bernard: selectivity↑ (was 22; gate5 PF~0.55–0.63; 32 NO-GO PF↓)
REBUY_COOLDOWN_MINUTES = 5  # Titan hyper GO Desk; was 40
MIN_LIQUIDITY_USD = 15_000.0
NEW_PAIR_MAX_AGE_HOURS = 36.0
EUR_USD = 1.08

# Snelheid
HUNT_INTERVAL_SEC = 15  # Titan hyper GO Desk; was 45
TICK_INTERVAL_SEC = 15  # Titan hyper GO Desk; was 45
