...
MAX_POSITIONS = 10
POSITION_SIZE_PCT = 2.0  # Desk GO A rollback pre-hyper; floor-hotfix blijft
...
MAX_HOLD_MINUTES = 45  # Desk GO A rollback pre-hyper; floor-hotfix blijft
ROTATE_SCORE_EDGE = 8.0  # Desk GO A rollback pre-hyper; floor-hotfix blijft

# Auto-koop
MIN_SCORE = 28.0              # Desk/Bernard: selectivity↑ (was 22; gate5 PF~0.55–0.63; 32 NO-GO PF↓)
REBUY_COOLDOWN_MINUTES = 40  # Desk GO A rollback pre-hyper; floor-hotfix blijft
MIN_LIQUIDITY_USD = 15_000.0
NEW_PAIR_MAX_AGE_HOURS = 36.0
EUR_USD = 1.08

# Snelheid
HUNT_INTERVAL_SEC = 45  # Desk GO A rollback pre-hyper; floor-hotfix blijft
TICK_INTERVAL_SEC = 45  # Desk GO A rollback pre-hyper; floor-hotfix blijft
