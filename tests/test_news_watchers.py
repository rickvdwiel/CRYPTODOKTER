...
class TestTrendWatchers(unittest.TestCase):
    ...
    def test_list_feeds_niet_leeg(self):
        ...
        self.assertIn("l2beat-gov", names)
        self.assertIn("delving-bitcoin", names)
        self.assertIn("bitcoin-dev", names)
        self.assertIn("b10c", names)
        self.assertIn("openzeppelin", names)
        self.assertIn("monero", names)
        self.assertIn("zcash", names)
        self.assertIn("joncharbonneau", names)
        self.assertIn("jito-gov", names)
