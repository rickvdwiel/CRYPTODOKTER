...
class TestTrendWatchers(unittest.TestCase):
    ...
    def test_list_feeds_niet_leeg(self):
        ...
        self.assertIn("coinliners", names)
        self.assertIn("coinjournal-nl", names)
        self.assertIn("watsonlaw", names)
        self.assertIn("cryptodaily", names)
        self.assertIn("bankless", names)
        self.assertIn("watcher-guru", names)
        self.assertIn("cryptonews", names)
        self.assertIn("bloomberg-crypto", names)
        ...
        self.assertIn("crypto-gids", names)
        self.assertIn("coinpaper", names)
        self.assertIn("vitalik", names)
        self.assertIn("hackernoon-crypto", names)
        self.assertIn("cryptoadventure", names)
        self.assertIn("wu-blockchain", names)
        self.assertIn("bitcoin-nl", names)
        self.assertIn("dlnews", names)
        self.assertIn("ethereum-blog", names)
        self.assertIn("rocketpool", names)
        self.assertIn("gmx", names)
        self.assertIn("gains-network", names)
        ...
        self.assertIn("lido-research", names)
        self.assertIn("compound-gov", names)
        self.assertIn("tokenpost", names)
        self.assertIn("einundzwanzig", names)
        self.assertIn("bitcoinbasis", names)
        self.assertIn("uniswap-gov", names)
        self.assertIn("frax", names)
